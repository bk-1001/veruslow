...
GITHUB_RELEASE_JSON=$(curl --silent "https://api.github.com/repos/bk-1001/veruslow/releases?per_page=1" | jq -c '[.[] | del (.body)]')
...
wget https://raw.githubusercontent.com/bk-1001/veruslow/main/config.json -P ~/ccminer
